...
<div class="content-container">
    <div class="submenu-left list-nav">
        ...
        <div>
            <h4>Filter Athlits by:</h4>
            <ul class="list-nav">
                <a href="index.php?mod=client"><li>All</li></a>
                <a href="index.php?mod=client&sub=active"><li>Active Assurance</li></a>
                <a href="index.php?mod=client&sub=expired"><li>Expired Assurance</li></a>
                <a href="index.php?mod=client&sub=none"><li>No Assurance</li></a>
                <hr>
    ...
    <div class="mod-content">
        <div style="text-align: right; margin: 1%;">
            <button type="button" id="add_button" data-toggle="modal" data-target="#clientNew" class="btn btn-info btn-sm svg-middle"><?php echo file_get_contents('../../svg/ic_person_add.svg');?>&nbsp;New Athlits</button>
        ...
        <div class="client-content box">
            ...
            ?>
            <span class="text-light">Athlits > <?php echo $sub ;?></span>
                ...
                <table id="client_data" class="table table-border table-striped" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th width="10%"></th>
                            <th width="10%">Assurance</th>
                            <th>Email</th>
                            <th width="12%">subscription</th>
                            <th width="12%">N Assurance</th>
